...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Dino Shakuru — Aspiring Full Stack Developer" },
      {
        property: "og:description",
        content:
          "Portfolio of Munyansanga Nziza Dino Shakuru — CS student at MKU building modern, responsive web apps.",
      },
